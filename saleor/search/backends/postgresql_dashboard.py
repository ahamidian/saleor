...
def search_orders(phrase):
    ...
    sv = (
        ...
        + SearchVector("user__default_address__first_name", weight="B")
        + SearchVector("user__default_address__last_name", weight="B")
...
def search_users(phrase):
    ...
    sv = (
        ...
        + SearchVector("default_address__first_name", weight="B")
    )
    rank = SearchRank(sv, SearchQuery(phrase))
